    ...
    func didReceiveData(data: Any) {
      print(data)
       ...
       DispatchQueue.main.sync {
            ...
            let secondViewController = storyboard.instantiateViewController(withIdentifier: "mainTableID") as! MainViewController
            secondViewController.model = (data as! [Password])
